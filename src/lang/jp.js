export default {
	...
	home: {
		...
		atrade: 'TREXグローバルステーションのアカウントを登録して、取引の旅を開始します。',
		Gcoin: 'TREX',
	...
	auth2: {
		...
		tip2: '証明書を持って撮った写真を提供してください。同じ写真にも「TREX」と日付とサインのコメントが含まれています。顔がよく見えるようにしてください。証明書の詳細は全部分かります',
		face: '顔がくっきりと見える',
		clearly: '写真が鮮明に見える',
		notes: '[TREX]の文字コメントが付いています',
		...
		tip4: ' ご本人のTREXアカウントの資産明細のスクリーンショットまたは写真を提供してください。画像にはお客様の口座名、uid、在庫保持の詳細、現在の時間が含まれています。すべての情報をクリアして読むことができます。',
