export default {
	...
	auth2: {
		...
		back: '증명서 뒷면',
		hand: '소지품 사진을 업로드하다',
		tip2: '동일 사진에 " TREX ", 날짜 및 서명이있는 주석이 포함 된 사진을 제공 하는 사진을 제공 합니다. 얼굴이 선명 하고 모든 문서 상세 정보를 읽을 수있는지 확인 하 십시오',
		face: '또렷하고 또렷한 얼굴',
		clearly: '사진 선명도',
		notes: '[TREX]가 있는 문자 주석',
		...
		tip4: ' 본인의 TREX 계정에 대한 자산 세부 정보 캡쳐 또는 사진을 입력 하 십시오. 사진에는 계정이름, uid, 토너 카트리지 상세 정보, 현재 시간이 포함 되 어있 습니다. 모든 정보를 읽을 수있 습니다.',
